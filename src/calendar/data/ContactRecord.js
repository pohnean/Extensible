/**
 * @class Ext.ensible.cal.ContactRecord
...
rec = new Ext.ensible.cal.ContactRecord({
    CalendarId: 5,
    Title: 'My Holidays',
 ...
 * If you have overridden any of the record's data mappings via the {@link Ext.ensible.cal.ContactMappings ContactMappings} object
 * you may need to set the values using this alternate syntax to ensure that the fields match up correctly:<pre><code>
var M = Ext.ensible.cal.ContactMappings;
 ...
 */
Ext.ensible.cal.ContactRecord = Ext.extend(Ext.data.Record, {
...
/**
 * Reconfigures the default record definition based on the current {@link Ext.ensible.cal.ContactMappings ContactMappings}
 * object. See the header documentation for {@link Ext.ensible.cal.ContactMappings} for complete details and 
 * examples of reconfiguring a ContactRecord.
 * @method create
 * @static
 * @return {Function} The updated ContactRecord constructor function
 */
Ext.ensible.cal.ContactRecord.reconfigure = function(){
    var C = Ext.ensible.cal,
        M = C.ContactMappings,
        proto = C.ContactRecord.prototype,
        fields = [];
    ...
    return C.ContactRecord;
};

// Create the default definition now:
Ext.ensible.cal.ContactRecord.reconfigure();